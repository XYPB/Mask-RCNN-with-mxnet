...
def get_resnet_train(anchor_scales, anchor_ratios, rpn_feature_stride,
    ...
    rpn_bbox_loss_ = rpn_bbox_weight_5 * mx.symbol.smooth_l1(name='rpn_bbox_loss_', scalar=3.0, data=(fpn_bbox_pred_5 - rpn_bbox_target_5))
    ...
    rois = mx.symbol.contrib.MultiProposal(
        cls_prob=rpn_cls_act_reshape_5, bbox_pred=fpn_bbox_pred_5, im_info=im_info, name='rois',
    ...
    # group output
    group = mx.symbol.Group([rpn_cls_prob_5, rpn_bbox_loss, cls_prob, bbox_loss, mx.symbol.BlockGrad(label)])
    return group
...
def get_resnet_test(anchor_scales, anchor_ratios, rpn_feature_stride,
    ...
    rpn_conv = mx.symbol.Convolution(
        data=conv_feat_5, kernel=(3, 3), pad=(1, 1), num_filter=512, name="rpn_conv_3x3")
